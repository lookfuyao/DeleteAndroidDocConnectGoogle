...
public class AndroidDoc {
    ...
    private static String androidSDKHome = "/data/tools/android-sdk-linux_x86/";

    public static void main(String[] args) {
        //Map<String, String> map = System.getenv();
        //androidSDKHome = map.get(ANDROID_SDK_HOME);
        if (androidSDKHome != null) {
            System.out.println("Detected the Android SDK Installation path:" + androidSDKHome);
            File docs = new File(androidSDKHome + "docs");
            System.out.println("It will take several minutes, please wait...");
            traverse(docs);
            System.out.println("Operation Down!!! Now you can visit Android Doc without waiting...");
        } else {
            System.out.println("Please configure the Android SDK Environment variable (ANDROID_SDK_HOME)!");
        }
    }
    ...
    private static void traverse(File dir) {
        if (dir.isDirectory()) {
            ...
            for (File file : files) {
                if (file.isDirectory()) {
                    System.out.println("Scanning Folder:" + file.getAbsolutePath());
                    traverse(file);
                } else {
                    doChange(file);
                }
